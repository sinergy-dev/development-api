...
<body style="display:block;width:600px;margin-left:auto;margin-right:auto;">
	<div style="line-height: 1.5em">
		<center><img style="width: 30%" src="{{env('API_LINK_CUSTOM2')}}/image/rejectedProgress.png" ></center>
	</div>
	<div style="line-height: 1.5em;padding: 10px;">
		<div style="color: #141414;font-family: 'Montserrat','Helvetica Neue',Helvetica,Arial,sans-serif;">
			...
			<p>
				Sorry you haven't had the opportunity to continue the next test.<br>
				<p>keep up the spirit and keep trying! Thank's for join us and do your best.</p>
			</p>
